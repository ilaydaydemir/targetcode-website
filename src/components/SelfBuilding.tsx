...
export function SelfBuilding() {
  return (
    <section id="self-building" className="relative py-24 overflow-hidden bg-black/80">
              ...
              <div className="bg-[#0d0d14] rounded-lg shadow-xl overflow-hidden border border-[#2a2a3e]">
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    <div className="flex items-center gap-1.5 text-xs text-gray-300 bg-[#1a1a2e] rounded-lg px-3 py-1.5">
