        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center">
              <span className="text-2xl font-bold font-[var(--font-roboto-mono)]">
                TargetCode<span className="text-clay-teal">.io</span>
              </span>
            </div>
            ...
            <div className="mt-6 flex space-x-6">
              <a href="#" className="text-gray-400 hover:text-clay-teal transition-colors">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><a href="mailto:hello@targetcode.io" className="text-base text-gray-400 hover:text-white transition-colors">Contact Us</a></li>
            </ul>
          </div>
        </div>
